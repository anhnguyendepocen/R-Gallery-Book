...
```{r evolution-line-chart-basic, echo=TRUE, message=FALSE, warning=FALSE}
# Libraries
library(ggplot2)
...
```{r evolution-line-chart-customize, echo=TRUE, message=FALSE, warning=FALSE}
# Libraries
library(ggplot2)
library(hrbrthemes)
...
```{r conntected-scatterplot-geompoint-custom, echo=TRUE, message=FALSE, warning=FALSE}
# Libraries
library(ggplot2)
library(dplyr)
library(hrbrthemes)
...
```{r evolution-line-chart-without-log, echo=TRUE, message=FALSE, warning=FALSE}
# Library
library(ggplot2)
...
```{r evolution-line-chart-linear-model-ci, echo=TRUE, message=FALSE, warning=FALSE}
# Library
library(ggplot2)
library(hrbrthemes)
...
```{r evolution-line-chart-dual-axis, echo=TRUE, message=FALSE, warning=FALSE}
# Libraries
library(ggplot2)
library(dplyr)
...
```{r evolution-line-chart-adding-second-y-axis, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r evolution-line-chart-two-series-one-chart, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r evolution-line-chart-dual-y-axis-customization, echo=TRUE, message=FALSE, warning=FALSE}
# Value used to transform the data
coeff <- 10
...
```{r evolution-line-chart-barplot-overlapping, echo=TRUE, message=FALSE, warning=FALSE}
# Value used to transform the data
coeff <- 10
...
```{r evolution-line-chart-error-envelop, echo=TRUE, message=FALSE, warning=FALSE}
library(ggplot2)
...
```{r streamgraph-evolution-control-offset, message=FALSE, warning=FALSE}
# Library
library(streamgraph)
...
```{r streamgraph-evolution-change-streamgraph-shape, echo=TRUE, message=FALSE, warning=FALSE}
# Library
library(streamgraph)
...
```{r streamgraph-evolution-change-streamgraph-color, echo=TRUE, message=FALSE, warning=FALSE}
# Library
library(streamgraph)
...
```{r streamgraph-evolution-dropdown-menu, echo=TRUE, message=FALSE, warning=FALSE}
# Library
library(streamgraph)
...
pp <- streamgraph(data, key="name", value="value", date="year", height="300px", width="600px") %>%
