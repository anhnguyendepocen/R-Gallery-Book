...
```{r method-one-forcats, message=FALSE, warning=FALSE}
# load the library
library(forcats)
...
```{r dplyr-sort-arrange, message=FALSE, warning=FALSE}
data %>%
...
```{r mutate-regions, message=FALSE, warning=FALSE}
data %>%
  arrange(val) %>%
...
```{r density-chart-ggplot, message=FALSE, warning=FALSE}
# Libraries
library(ggplot2)
library(dplyr)
...
```{r density-chart-ggplot-custom-theme, message=FALSE, warning=FALSE}
# Libraries
library(ggplot2)
library(dplyr)
library(hrbrthemes)
...
```{r density-chart-geo-density, message=FALSE, warning=FALSE}
# Libraries
library(ggplot2)
library(hrbrthemes)
...
```{r density-chart-several-groups, message=FALSE, warning=FALSE}
# Libraries
library(ggplot2)
library(hrbrthemes)
library(dplyr)
...
```{r density-chart-several-groups-transparency, message=FALSE, warning=FALSE}
...
```{r density-chart-group-distinction-distributions, message=FALSE, warning=FALSE}
# Load dataset from github
data <- read.table("https://raw.githubusercontent.com/zonination/perceptions/master/probly.csv", header=TRUE, sep=",")
data <- data %>%
  gather(key="text", value="value") %>%
...
```{r density-chart-small-multiple, message=FALSE, warning=FALSE}
...
```{r marginal-distribution-ggplot, message=FALSE, warning=FALSE}
# library
library(ggplot2)
library(ggExtra)
...
```{r marginal-distribution-ggplot-plot-one, message=FALSE, warning=FALSE}
p1
```


```{r marginal-distribution-ggplot-plot-two, message=FALSE, warning=FALSE}
p2
```

```{r marginal-distribution-ggplot-plot-three, message=FALSE, warning=FALSE}
p3
```
...
```{r marginal-distribution-ggplot-more-customizations, message=FALSE, warning=FALSE}
# library
library(ggplot2)
library(ggExtra)
...
```{r marginal-distribution-ggplot-set-relative-marginal, message=FALSE, warning=FALSE}
p1
```


```{r marginal-distribution-ggplot-custom-marginal, message=FALSE, warning=FALSE}
p2
```


```{r marginal-distribution-ggplot-only-marginal-plot, message=FALSE, warning=FALSE}
p3
```
...
```{r histogram-basic-ggplot, message=FALSE, warning=FALSE}
# library
library(ggplot2)
...
```{r histogram-basic-ggplot-control-binwidth, message=FALSE, warning=FALSE}
# Libraries
library(tidyverse)
library(hrbrthemes)
...
```{r histogram-basic-ggplot-several-groups, message=FALSE, warning=FALSE}
# library
library(ggplot2)
library(dplyr)
library(hrbrthemes)
...
```{r histogram-boxplot-top, message=FALSE, warning=FALSE}
# Create data 
...
```{r custom-proportions-window-width, message=FALSE, warning=FALSE}
# Dummy data
a <- seq(129,1)+4*runif(129,0.4)
b <- seq(1,129)^2+runif(129,0.98)
