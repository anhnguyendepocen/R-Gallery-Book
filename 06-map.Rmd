...
```{r map-draw-connections-map-html, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r map-draw-add-three-connections-map-html, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r map-show-connections-map-html, echo=TRUE, message=FALSE, warning=FALSE}
# Load geosphere
library(geosphere)
...
```{r map-correcting-connections-map-html, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r map-link-connections-map-html, echo=TRUE, message=FALSE, warning=FALSE}
# Background map
...
```{r map-apply-several-cities-pairs-connections-map-html, echo=TRUE, message=FALSE, warning=FALSE}
# Create dataset
data <- rbind(
    Buenos_aires=c(-58,-34),
    Paris=c(2,49),
...
```{r map-alternative-connections-map-html, echo=TRUE, message=FALSE, warning=FALSE}
