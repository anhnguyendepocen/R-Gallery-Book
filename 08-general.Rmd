...
```{r ggplot-add-labels-selection-marker, echo=TRUE, message=FALSE, warning=FALSE}
# library
library(ggplot2)
library(dplyr)
library(tibble)
...
```{r ggplot-marginal-distribution, echo=TRUE, message=FALSE, warning=FALSE}
# library
library(ggplot2)
library(ggExtra)
...
```{r ggplot-more-customization, echo=TRUE, message=FALSE, warning=FALSE}
# library
library(ggplot2)
library(ggExtra)
...
```{r ggplot-customize-axis-ticks-axis-lines, echo=TRUE, message=FALSE, warning=FALSE}
# chart 1: ticks
basic + theme(
...
```{r ggplot-facet-grid, echo=TRUE, message=FALSE, warning=FALSE}
...
![](https://www.r-graph-gallery.com/89-box-and-scatter-plot-with-ggplot2_files/figure-html/unnamed-chunk-3-1.png)![](https://www.r-graph-gallery.com/89-box-and-scatter-plot-with-ggplot2_files/figure-html/unnamed-chunk-3-2.png)
...
<center>
  ![](https://www.r-graph-gallery.com/297-circular-barplot-with-groups_files/figure-html/thecode4-1.png){85%}
</center>
