...
```{r parallel-coordinates-ggally, echo=TRUE, message=FALSE, warning=FALSE}
# Libraries
library(GGally)
...
```{r parallel-coordinates-ggally-custom, echo=TRUE, message=FALSE, warning=FALSE}
# Libraries
library(hrbrthemes)
library(GGally)
library(viridis)
...
```{r parallel-coordinates-ggally-scaling, echo=TRUE, message=FALSE, warning=FALSE}
ggparcoord(data,
    columns = 1:4, groupColumn = 5, order = "anyClass",
    scale="globalminmax",
    showPoints = TRUE, 
...
```{r parallel-coordinates-ggally-highlighting-group, echo=TRUE, message=FALSE, warning=FALSE}
# Libraries
library(GGally)
library(dplyr)
...
```{r parallel-chart-mass-lib, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r parallel-chart-mass-lib-reorder-variables, echo=TRUE, message=FALSE, warning=FALSE}
# You need the MASS library
library(MASS)
...
```{r parallel-chart-mass-lib-highlight-group, echo=TRUE, message=FALSE, warning=FALSE}
# You need the MASS library
library(MASS)
...
```{r circular-barplot, echo=TRUE, message=FALSE, warning=FALSE}
# Libraries
library(tidyverse)
...
```{r circular-barplot-labels, echo=TRUE, message=FALSE, warning=FALSE}
# Libraries
library(tidyverse)
...
```{r circular-barplot-groups, echo=TRUE, message=FALSE, warning=FALSE}
# library
library(tidyverse)
...
```{r circular-barplot-space-between-groups, echo=TRUE, message=FALSE, warning=FALSE}
# library
library(tidyverse)
...
```{r order-bars, echo=TRUE, message=FALSE, warning=FALSE}
# Order data:
...
```{r circular-barplot-customization, echo=TRUE, message=FALSE, warning=FALSE}
# library
library(tidyverse)
